...
class WebsiteTemplateController {
    ...
    // default controller action. Modified by Darin to aid with debugging.
    ...
    // written by Darin for acquiring the necessary thumbnail images from the model by the view
    ...
    // written by darin for acquiring the proper Large image from the model by the view
    ...
    // the following methods are generated by Grails when the project is created.
